...
/* themes/custom/mbase/templates/navigation/toolbar.html.twig */
class __TwigTemplate_7e3e978ee02d520b7964f0f90585a52c8b41912e55aa2bffdc267b208617d502 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["for" => 26, "spaceless" => 31, "if" => 33];
        $filters = ["escape" => 23];
        $functions = [];
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tray"]) {
            ...
            // line 32
            echo "    <div";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["tray"], "attributes", [])), "html", null, true);
            echo ">
    ";
            // line 33
            if ($this->getAttribute($context["tray"], "label", [])) {
                // line 34
                echo "      <nav class=\"toolbar-lining clearfix\" role=\"navigation\" aria-label=\"";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["tray"], "label", [])), "html", null, true);
                echo "\">
    ...
    ";
            ...
            // line 39
            echo "        ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["tray"], "links", [])), "html", null, true);
            echo "
      </nav>
    </div>
    ";
...
";
    ...
    {
        return "themes/custom/mbase/templates/navigation/toolbar.html.twig";
    }
    ...
    {
        return array (  128 => 44,  122 => 43,  114 => 39,  110 => 37,  105 => 35,  100 => 34,  98 => 33,  93 => 32,  90 => 31,  86 => 30,  83 => 29,  72 => 27,  68 => 26,  64 => 25,  60 => 24,  55 => 23,);
    }
    ...
    {
        return new Source("", "themes/custom/mbase/templates/navigation/toolbar.html.twig", "/Users/ddeitsch/Sites/devdesktop/mhco/themes/custom/mbase/templates/navigation/toolbar.html.twig");
    }
}
